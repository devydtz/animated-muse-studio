      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 md:px-8">
        ...
        <div className="flex items-center gap-2">
          <a
            ...
            className="grid h-9 w-9 place-items-center rounded-full border border-border/60 bg-card/60 text-muted-foreground transition hover:border-[#5865F2]/50 hover:bg-[#5865F2]/10 hover:text-[#5865F2]"
          >
