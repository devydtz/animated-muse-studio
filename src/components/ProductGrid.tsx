    ...
    <section className="px-6 pb-24">
      <div className="mx-auto grid max-w-6xl gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {products.map((p) => (
          <article
            key={p.name}
            className={`pixel-card relative flex flex-col rounded-2xl p-7 ${
          ...
          >
            ...
            <div className="mt-6 flex items-center justify-between border-t border-border/40 pt-5">
              ...
              <button className="rounded-full bg-primary px-5 py-2 text-sm font-semibold text-primary-foreground transition hover:bg-accent">
                Purchase
              </button>
            </div>
          </article>
