...
const items: Array<{
  ...
  { id: "rank-vip", category: "rank", name: "VIP Rank", copy: "Access exclusive commands, colored chat, and VIP-only areas.", price: "$4.99", rarity: "Rare", Icon: Crown },
  { id: "rank-legend", category: "rank", name: "Legend Rank", copy: "The ultimate rank. Custom prefix, fly in survival, and more.", price: "$19.99", rarity: "Legendary", Icon: Sparkles },
  { id: "key-lunar", category: "key", name: "Lunar Key", copy: "Open the Lunar Crate for a chance at the rarest gear on the server.", price: "$7.99", rarity: "Legendary", Icon: KeyRound },
  { id: "bundle-starter", category: "bundle", name: "Starter Bundle", copy: "VIP Rank + 3 Crate Keys + $2 store credit. Perfect start.", price: "$9.99", rarity: "Rare", Icon: Package },
];
