...
const bundles: Product[] = [
  {
    name: "Starter Bundle", tagline: "VIP Rank + 3 Crate Keys + $2 store credit. Perfect start.", price: "$9.99", rarity: "Rare", Icon: Gift,
    perks: ["VIP Rank (lifetime)", "3× Rare Keys", "$2 store credit", "Welcome cosmetic"],
  },
  {
    name: "Adventurer Bundle", tagline: "Everything you need to thrive across worlds.", price: "$19.99", rarity: "Epic", Icon: Package, featured: true,
    perks: ["Knight Rank", "5× Rare + 2× Epic Keys", "$5 store credit", "Exclusive cape"],
  },
  {
    name: "Lunar Bundle", tagline: "Walk in moonlight with the Lunar pack.", price: "$34.99", rarity: "Legendary", Icon: Moon,
    perks: ["Lunar Rank", "3× Lunar Keys", "Custom particle trail", "$10 store credit"],
  },
  {
    name: "Legend Bundle", tagline: "The ultimate package for serious players.", price: "$49.99", rarity: "Legendary", Icon: Sparkles,
    perks: ["Legend Rank", "5× Lunar Keys", "1× Eclipse Key", "$15 store credit", "Custom prefix"],
  },
  {
    name: "Eclipse Bundle", tagline: "Limited. Devastating. Unforgettable.", price: "$79.99", rarity: "Mythic", Icon: Sparkles,
    perks: ["Mythic Rank", "3× Eclipse Keys", "Eclipse wings cosmetic", "$25 store credit", "Personal /warp"],
  },
  {
    name: "Guild Bundle", tagline: "Equip your squad — 4 VIP ranks at a discount.", price: "$15.99", rarity: "Rare", Icon: Gift,
