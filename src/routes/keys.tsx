...
const keys: Product[] = [
  {
    id: "key-common", category: "key", name: "Common Key", tagline: "Open the Common Crate. Reliable, useful loot.", price: "$1.99", rarity: "Common", Icon: Key,
    perks: ["Enchanted tools", "Building blocks", "Food bundles", "Small chance of rare drops"],
  },
  {
    id: "key-rare", category: "key", name: "Rare Key", tagline: "Unlock the Rare Crate for upgraded gear.", price: "$3.99", rarity: "Rare", Icon: KeyRound,
    perks: ["Diamond gear (enchanted)", "Rare cosmetics", "XP boosters", "Chance at Epic drops"],
  },
  {
    id: "key-epic", category: "key", name: "Epic Key", tagline: "Crack the Epic Crate. Powerful rewards await.", price: "$5.99", rarity: "Epic", Icon: KeyRound, featured: true,
    perks: ["Netherite gear", "Custom enchants", "Pet eggs", "Particle trails"],
  },
  {
    id: "key-lunar", category: "key", name: "Lunar Key", tagline: "Open the Lunar Crate for a chance at the rarest gear on the server.", price: "$7.99", rarity: "Legendary", Icon: Moon,
    perks: ["Mythic enchants", "Exclusive Lunar cosmetics", "Rare pet eggs", "Chance at Mythic gear"],
  },
  {
    id: "key-eclipse", category: "key", name: "Eclipse Key", tagline: "The rarest crate of all. Open at your own risk.", price: "$12.99", rarity: "Mythic", Icon: Sparkles,
    perks: ["Guaranteed Mythic item", "Custom particle wings", "Eclipse-only cosmetics", "Bonus 1,000 server coins"],
  },
  {
    id: "key-bundle-10", category: "key", name: "Key Bundle ×10", tagline: "10 Rare Keys at a discount.", price: "$29.99", rarity: "Epic", Icon: KeyRound,
